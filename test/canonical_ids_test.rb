  ...
  module Canonical
    class IdsTest < Minitest::Test
      ...
      def test_account_id_portable_ref_collides_across_institutions
        ...
        ing      = Canonical.account_id(institution: "ing",      portable_ref: "1465:1272")
        fintonic = Canonical.account_id(institution: "fintonic", portable_ref: "1465:1272")
      ...
      def test_account_id_portable_ref_distinguishes_distinct_accounts
        a = Canonical.account_id(institution: "ing", portable_ref: "1465:1272")
      ...
      def test_account_id_portable_ref_strips_whitespace
        a = Canonical.account_id(institution: "ing", portable_ref: "1465:1272")
        b = Canonical.account_id(institution: "ing", portable_ref: "  1465:1272  ")
        assert_equal a, b
      end
      ...
      def test_account_id_portable_ref_overrides_other_refs
        ...
        with_portable = Canonical.account_id(
          ...
          iban: "ES5914650100981714391272", source_id: "ing-uuid", name: "Cuenta Naranja"
        )
        portable_only = Canonical.account_id(institution: "x", portable_ref: "1465:1272")
