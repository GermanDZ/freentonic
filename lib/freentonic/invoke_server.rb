...
module Freentonic
  ...
  class InvokeServer
    ...
    # The shared mutex that serializes /invoke. Exposed so external
    # dispatchers can hold it across a richer operation (e.g. the
    # simplefreen scheduler serializing its outbound /invoke calls).
