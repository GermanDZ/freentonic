...
require "uri"
require "json"
require_relative "api_client/interpolation"
require_relative "api_client/cursor_pagination"
...
module Freentonic
  ...
  #
  class ApiClient
    # Template interpolation ({name}/{name|date}/{offset}) and declarative
    # cursor pagination live in their own files (private instance methods).
